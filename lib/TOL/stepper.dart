...
/// The state of a [StepTol] which is used to control the style of the circle and
/// text.
///
/// See also:
///
...
/// Defines the [StepperTol]'s main axis.
enum StepperType {
...
/// A material step used in [StepperTol]. The step can have a title and subtitle,
...
@immutable
class StepTol {
  /// Creates a step for a [StepperTol].
  ///
...
///  * [StepTol]
///  * <https://material.io/archive/guidelines/components/steppers.html>
class StepperTol extends StatefulWidget {
  ...
  @override
  _StepperTolState createState() => _StepperTolState();
}

class _StepperTolState extends State<StepperTol> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(StepperTol oldWidget) {
...
//      color: Colors.grey.shade400,
  ...
  Widget _buildCircleChild(int index, bool oldState) {
    final StepState state = oldState
        ? _oldStates[index] as StepState
        : widget.steps[index].state as StepState;
...
//          color: _circleColor(index),
  ...
  //       onStepCancelvivq: widget.onStepCancel
  //     );
...
//                  color: Colors.grey.shade400,
  ...
  Widget build(BuildContext context) {
    ...
    assert(() {
      if (context.findAncestorWidgetOfExactType<StepperTol>() != null)
