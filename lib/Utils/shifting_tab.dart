...
// class ShiftingTab extends Widget {
//   ShiftingTab({
//     this.key,
//     required this.text,
...
//     Animatable<Color> _tabColor = tabColor ??
//         TweenSequence<Color>([
//           TweenSequenceItem(
//               weight: 1.0,
//               tween: ColorTween(
//                 begin: CoupledTheme().backgroundColor,
//                 end: CoupledTheme().primaryBlue,
//               ) as Animatable<Color>),
//         ]);
//     final Tween<double> tween = Tween<double>(begin: 1.0, end: 1.0 + labelFlex);
//     final dynamic color = brightness == Brightness.dark
...
//         child: _buildTab(animation, color, _tabColor, margin, context),
//       ),
//     );
//   }
...
//         child:
//             GlobalWidgets().iconCreator(iconPath, size: FixedIconSize.SMALL));
//   }
...
//   @override
//   Animation<double> get parent => controller.animation as Animation<double>;
...
class _ShiftingTabWidget extends AnimatedWidget {
  ...
  Widget _buildIcon(Color? color, double? margin, TextDirection dir) {
    return Center(
      child: GlobalWidgets().iconCreator(iconPath, size: FixedIconSize.SMALL),
    );
  }
