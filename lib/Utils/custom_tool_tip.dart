...
class CustomTooltip extends StatefulWidget {
  ...
  /// Whether the tooltip's [tooltipWidget] should be excluded from the semantics
  /// tree.
  ///
  /// Defaults to false. A tooltip will add a [Semantics.label] that is set to
  /// [CustomTooltip.tooltipWidget]. Set this property to true if the app is going to
  ...
  /// [ThemeData.textTheme.bodyText1] will be used with [Colors.white]. Otherwise,
  /// if [ThemeData.brightness] is set to [Brightness.light],
  /// [ThemeData.textTheme.bodyText1] will be used with [Colors.black].
...
class _CustomTooltipState extends State<CustomTooltip>
  ...
  void _createNewEntry() {
    ...
    SemanticsService.tooltip("Hellow");
  }
  ...
  void _handlePointerEvent(PointerEvent event) {
    if (_entry == OverlayEntry(builder: (BuildContext context) => SizedBox())) {
      return;
    }
            ...
            child: ConstrainedBox(
              ...
              child: DefaultTextStyle(
                ...
                child: Container(
                  ...
                  margin: margin,
                  child: Center(
                      widthFactor: 1.0, heightFactor: 1.0, child: message),
                ),
              ),
            ),
          ),
