...
// part of 'profile_final.dart';

// // **************************************************************************
// // JsonSerializableGenerator
// // **************************************************************************

// ProfileResponseFinal _$ProfileResponseFinalFromJson(Map<String, dynamic> json) {
//   return ProfileResponseFinal(
//     id: json['id'] as int ?? 0,
...
//         ?.map((e) => e == null
//             ? null
//             : UserCouplingFinal.fromJson(e as Map<String, dynamic>))
//         ?.toList(),
...
// Map<String, dynamic> _$ProfileResponseFinalToJson(
//         ProfileResponseFinal instance) =>
//     <String, dynamic>{
//       'id': instance.id,
//       'name': instance.name,
...
// UserCouplingFinal _$UserCouplingFinalFromJson(Map<String, dynamic> json) {
//   return UserCouplingFinal(
//     id: json['id'] as int ?? 0,
//     userId: json['user_id'] as int ?? 0,
...
// Map<String, dynamic> _$UserCouplingFinalToJson(UserCouplingFinal instance) =>
//     <String, dynamic>{
//       'id': instance.id,
//       'user_id': instance.userId,
